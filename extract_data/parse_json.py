...
def parse_json(source_file: str, target_file: str) -> None:
    ...
    with open(source_file) as f:
        ...
        fields_to_remove = [
            "url", "alt_name", "title_color", "text_color", "id",
            "image_url", "birthday_month", "birthday_day", "sign", "quote",
            "phrase", "clothing", "islander", "debut", "prev_phrases",
            "nh_details", "appearances"
        ]
